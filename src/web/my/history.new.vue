...
export default {
  ...
  methods: {
    ...
    selectp(findex, index) {
      ...
      this.allData[findex].browsingHistoryPO[index].ischecked = !this.allData[
        findex
      ].browsingHistoryPO[index].ischecked;
      if (!this.allData[findex].browsingHistoryPO[index].ischecked) {
        ...
        let arr2 = this.delData.childDTOList,
          tmpData = { time: time, historyId: historyId };
    ...
    selectAllp(findex) {
      ...
      this.allData[findex].browsingHistoryPO.map(item => {
        this.allData[findex].isAllChecked
          ? (item.ischecked = true)
